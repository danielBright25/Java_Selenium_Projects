...
public class DifferentlocatersGitHub {
	...
	highlight(driver,driver.findElement(By.id("login_field")));
       ...
       highlight(driver, driver.findElement(By.name("password")));
        Thread.sleep(3000);
       highlight(driver, driver.findElement(By.className("octicon octicon-mark-github SessionsAuthHeader-module__avatarCoinGithub__n0H61")));
        Thread.sleep(3000);
